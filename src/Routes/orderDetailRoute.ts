...
import { createOrderDetail, getOrderDetails, getOrderDetailById, updateOrderDetail, deleteOrderDetail, getOrderDetailsByOrderId } from "../Controllers/orderDetailController.js";
...
router.get("/order/:orderId", authenticate, authorize(["admin", "customer"]), getOrderDetailsByOrderId);
